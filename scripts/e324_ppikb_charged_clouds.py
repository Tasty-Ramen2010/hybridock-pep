...
Prep-test:  python scripts/e324_ppikb_charged_clouds.py --prep-test 5
Full (chained after e323):  OMP_NUM_THREADS=1 python scripts/e324_ppikb_charged_clouds.py
"""
