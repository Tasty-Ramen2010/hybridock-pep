...
Run: OMP_NUM_THREADS=2 python scripts/e354_confinement_entropy.py --smoke        # 1-2 peptides, validate pipeline
     OMP_NUM_THREADS=2 python scripts/e354_confinement_entropy.py --gate --n 30   # the decisive correlation test
"""
