...
Run: OMP_NUM_THREADS=2 python scripts/e360_prism_s_optimized.py --bench      # time one complex, all-platform ETA
     OMP_NUM_THREADS=2 python scripts/e360_prism_s_optimized.py --gate --n 20 --windows 3 --ps 300
"""
