...
e150 = __import__("importlib").util.module_from_spec(
    __import__("importlib").util.spec_from_file_location("e150", ROOT / "scripts/e150_protdcal_descriptors.py"))
__import__("importlib").util.spec_from_file_location("e150", ROOT / "scripts/e150_protdcal_descriptors.py").loader.exec_module(e150)
SCALES = e150.SCALES
SN = list(SCALES.keys())
T2O = e179.T2O
