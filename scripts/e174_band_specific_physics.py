...
e108 = importlib.util.module_from_spec(importlib.util.spec_from_file_location("e108", ROOT / "scripts/e108_ingest_pdbbind.py"))
importlib.util.spec_from_file_location("e108", ROOT / "scripts/e108_ingest_pdbbind.py").loader.exec_module(e108)
