...
Usage:
  python3 experiments/e229_pocket_md_pilot.py --smoke              # 1 receptor, tiny MD, CPU — validate pipeline
  python3 experiments/e229_pocket_md_pilot.py --platform CUDA      # full 23-receptor run (background)
  python3 experiments/e229_pocket_md_pilot.py --eval-only          # just re-run the correlation from cache
"""
