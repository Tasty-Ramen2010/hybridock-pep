...
Run: OMP_NUM_THREADS=2 python experiments/e358_conformational_entropy.py --smoke
     OMP_NUM_THREADS=2 python experiments/e358_conformational_entropy.py --gate --n 40
"""
