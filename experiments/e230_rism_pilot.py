...
Usage:
  python3 experiments/e230_rism_pilot.py --smoke --pdb 4e34     # one receptor, validate the pipeline
  python3 experiments/e230_rism_pilot.py                        # full run over the manifest
  python3 experiments/e230_rism_pilot.py --eval-only
"""
