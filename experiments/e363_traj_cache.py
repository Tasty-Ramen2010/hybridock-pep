...
Run: OMP_NUM_THREADS=2 python experiments/e363_traj_cache.py --build --n 32     # simulate once, cache
     OMP_NUM_THREADS=1 python experiments/e363_traj_cache.py --analyze          # re-derive all formulas offline
"""
